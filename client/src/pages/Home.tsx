        ...
        <div className="relative px-4 sm:px-5">
          ...
          {/* <div className="mt-8 sm:mt-12 xl:mt-18 max-w-3xl ps-0 xl:ps-20 mx-auto xl:mx-0 text-center xl:text-left">
            <p className="text-white text-base sm:text-lg md:text-2xl leading-[1.3]">
              ...
              ideal brand for <br className="hidden sm:block" /> creating
        ...
        <section className="mt-10 sm:mt-14 xl:mt-17 ps-0 xl:ps-20 px-4 sm:px-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <p className="text-[#8A8A8A] text-sm leading-[1.35] tracking-wide text-center md:text-left">
              ...
              running and urban sectors. Laboratory tests and practical trials
              ensure the best experience of use and usage by the end consumer.
            </p>
          </div>
        </section>
      </section>
